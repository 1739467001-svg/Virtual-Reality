...
- ✋ **移动家具** — 开启“移动模式”，走到家具前点击拾起，看向地面再点击放下，所见即所得地重新布置。**各房间的家具（床 / 床头柜 / 衣柜 / 马桶 / 洗手台 / 淋浴房等）都是可拾取的实体**，能移动 / 旋转 / 换色 / 缩放 / 删除，并随分享链接保存。
- ➕ **增删家具** — 家具目录涵盖真实 glTF（真皮沙发 / 锦缎单椅 / 花瓶花艺），程序化家具（扶手椅 / 凳子 / 边几 / 坐墩 / 绿植 / 床 / 餐桌椅 / 落地灯 / 边柜），以及小摆件（花瓶 / 书籍 / 相框 / 地球仪 / 蜡烛）；放入房间后移动模式下选中按 `Delete` 删除。
...
- 🎨 **软装切换** — 一键更换墙面颜色（暖白 / 米灰 / 雾蓝 / 鼠尾草 / 浅杏）、地板（橡木 / 胡桃 / 白蜡 / 灰木）、厨房柜体台面配色（4 套）；**挂画可换 6 种画作**（日出 / 蓝天 / 紫昏 / 海景 / 森林 / 抽象，客厅与卧室一起切换）。绿植 / 花瓶等摆件也是**可拾取移动**的实体。均写入分享链接。
- 🪟 **真实空间 & 生活细节** — 带窗户（含室外景观）、半开的门、踢脚线、挂画、书架等；各房间还有生活化点缀：厨房果盘 / 调料瓶 / 刀架 / 水壶 / 吊灯，卫生间毛巾 / 地垫 / 置物架 / 绿植，卧室床头挂画 / 角落绿植，入户门垫等。
